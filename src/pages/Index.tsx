...
const Index = () => {
  ...
  const galleryItems = [
    ...
    {
      id: 3,
      title: 'Дома села Введенская Готня',
  ...
  const audioRecordings = [
    ...
    { id: 2, title: 'Воспоминания о сельском быте села Готня', duration: '18:22', year: '2025' },
    { id: 3, title: 'Быт храма в селе Красное', duration: '1:34', year: '2025' }
  ];
      ...
      <section id="home" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">Документальный архив деревень и сел Белгородской области. Фотографии и аудиозаписи, хранящие историю наших поселений.</p>
          </div>
          ...
          <div className="relative border-8 border-primary/30 rounded-lg overflow-hidden shadow-2xl animate-fade-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex items-end p-8">
              <div className="text-primary-foreground flex items-center justify-between w-full">
                <div>
                  <p className="text-3xl font-serif font-extrabold">Село Красное, Храм святого Илии Пророка
</p>
                  <p className="mt-2 text-lg font-light">Живописный храм, одно из достопримечательностей села</p>
                </div>
                <Button 
                  size="lg"
          ...
          <Card className="border-4 border-primary/30 bg-card shadow-2xl">
            <CardContent className="p-8 md:p-12">
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-lg leading-relaxed text-muted-foreground">Миссия проекта — сохранить для будущих поколений аутентичный облик и атмосферу белгородских деревень, которые в будущем могут исчезнуть или кардинально измениться.</p>
              </div>
            </CardContent>
          </Card>
        </div>
